...
describe 'V2.0.0' do
	before(:each) do
  	...
  	it "Venues" do
        ...
        venue_1 = Venue.create!(id:1, venue_network: venue_network, name: "AAA", venue_type:venue_type, latitude: 49.153, longitude: -123.436, featured: false, timezone: "America/Vancouver", start_time: Time.now-3.hours, end_time: Time.now+3.hours)
        ...
        venue_3 = Venue.create!(id:3, venue_network: venue_network, name: "CCC", venue_type:venue_type, latitude: 49.463, longitude: -123.312, featured: false, timezone: "America/Vancouver", start_time: Time.now-3.hours, end_time: Time.now+3.hours)
        ...
        venue_5 = Venue.create!(id:5, venue_network: venue_network, name: "CCC", venue_type:venue_type, latitude: 49.423, longitude: -123.532, featured: false, timezone: "America/Vancouver", start_time: Time.now-3.hours, end_time: Time.now+3.hours)
