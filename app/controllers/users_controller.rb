  ...
  def index
    ...
    users = Jbuilder.encode do |json|
      json.array! current_user.fellow_participants do |user|
        ...
        json.before_sending_whisper_notification current_user.read_notification.present? ? current_user.read_notification.before_sending_whisper_notification : false
