      ...
      if !s.nil?
        ...
        if s.destroy_single
          ...
          if Rails.env == "production"
            RecentActivity.delay.add_activity(shout_author_id, '303', nil, nil, "your-shout-deleted-"+shout_author_id.to_s+"-"+Time.now.to_i.to_s, nil, nil, 'A shout you posted has been flagged as inappropriate and removed')
