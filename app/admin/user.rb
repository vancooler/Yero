ActiveAdmin.register User do
  ...
  controller do
    ...
    def send_whisper
      ...
      if !user.nil?
        ...
        WhisperNotification.send_whisper(user.id.to_s, origin_user, 0, '2', 'Here is static message generated by server', (origin_user.username.nil? ? origin_user.first_name : origin_user.username) + " just sent you a whisper" )
      end
  ...
  show do |ad|
    ...
    attributes_table_for ad do
      ...
      table_for ad.secondary_avatars.where(is_active: true).order(:order) do
